...
public class PE011_Largest_product_in_a_grid {
	public static void main(String[] args) {
		...
		System.out.println("Runtime: " + runtime / 1000 + "ms (" + runtime
				+ "ns)");
	}
	...
	public static int prod(int r, int c, int[][] mat, int dir, int left) {
		...
		switch (dir) {
		case 0: {
			int[] arr = { mat[r][c] * prod(r - 1, c, mat, 1, left - 1),
					mat[r][c] * prod(r - 1, c - 1, mat, 2, left - 1),
					mat[r][c] * prod(r, c - 1, mat, 3, left - 1),
					mat[r][c] * prod(r + 1, c - 1, mat, 4, left - 1),
					mat[r][c] * prod(r + 1, c, mat, 5, left - 1),
					mat[r][c] * prod(r + 1, c + 1, mat, 6, left - 1),
					mat[r][c] * prod(r, c + 1, mat, 7, left - 1),
					mat[r][c] * prod(r - 1, c + 1, mat, 8, left - 1) };
			int max = -1;
		...
		case 1:
			return mat[r][c] * prod(r - 1, c, mat, 1, left - 1);
		case 2:
			return mat[r][c] * prod(r - 1, c - 1, mat, 2, left - 1);
		case 3:
			return mat[r][c] * prod(r, c - 1, mat, 3, left - 1);
		case 4:
			return mat[r][c] * prod(r + 1, c - 1, mat, 4, left - 1);
		case 5:
			return mat[r][c] * prod(r + 1, c, mat, 5, left - 1);
		case 6:
			return mat[r][c] * prod(r + 1, c + 1, mat, 6, left - 1);
		case 7:
			return mat[r][c] * prod(r, c + 1, mat, 7, left - 1);
		case 8:
			return mat[r][c] * prod(r - 1, c + 1, mat, 8, left - 1);
		}
